...
public class ConfigLoader {
    ...
    public String getSearchText() {
        String  prop = properties.getProperty("searchText");
        if (prop != null) return  prop;
        else  throw  new RuntimeException("property searchText is not specified in the config.properties file");
    }
}
